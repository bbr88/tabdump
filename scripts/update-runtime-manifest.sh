...
TRACKED_FILES=(
  ...
  "core/tab_policy/__init__.py"
  "core/tab_policy/actions.py"
  "core/tab_policy/matching.py"
  "core/renderer/__init__.py"
  "core/renderer/buckets.py"
  "core/renderer/classify.py"
  "core/renderer/config.py"
  "core/renderer/normalize.py"
  "core/renderer/priority.py"
  "core/renderer/renderer.py"
  "core/renderer/rendering.py"
  "core/renderer/stats.py"
  "core/renderer/validate.py"
